 ...
 <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; color: #333;">
        ...
        <div style="padding: 20px; background: #ffffff; border: 1px solid #ddd;">
          ...
          <p style="font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
            Thank you for registering to  <strong style="color: #E16254;">Code Breaker Challenge</strong> <strong>${studentName}</strong>. Your submission is currently under verification. We’ll notify you as soon as the verification process is complete.
          </p>
          <p style="font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
